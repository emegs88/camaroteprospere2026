  ...
  return (
    <AppLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-white">Prospere Hortolândia Futsal</h1>
        ...
        <GridIngressos categoria="FUTSAL" titulo="Prospere Hortolândia Futsal — 10 camarotes" total={10} />
      </div>
    </AppLayout>
  )
}
